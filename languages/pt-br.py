...
"<p style='padding:10px;'></p>": "<p style='padding:10px;'></p>",
"<p style='padding:10px;'>Click to enter web2py admin interface using the password you defined on startup<br /> NOTE: requires SSL if running on remote server</p>": "<p style='padding:10px;'>Click to enter web2py admin interface using the password you defined on startup<br /> NOTE: requires SSL if running on remote server</p>",
"<p style='padding:10px;'>Click to enter web2py admin interface</p>": "<p style='padding:10px;'>Click to enter web2py admin interface</p>",
"<p style='padding:10px;'>dfdfdfdf</p>": "<p style='padding:10px;'>dfdfdfdf</p>",
'About': 'About',
